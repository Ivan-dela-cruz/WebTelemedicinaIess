<div class="intro-y box p-5">
        ...
        <label>Código</label>
        {!! Form::text('code', null,['id'=>'code','class'=>'input w-full border mt-2']) !!}
        @error('code')
    ...
    <div class="text-right mt-5">
        <a type="button" class="button w-24 border dark:border-dark-5 text-gray-700 dark:text-gray-300 mr-1" href="{{route('get-diagnostics')}}">Cancelar</a>
