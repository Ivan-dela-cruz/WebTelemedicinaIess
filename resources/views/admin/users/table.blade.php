<table class="table table-report -mt-2">
    <thead>
        <tr>
            ...
            <th class="text-center whitespace-no-wrap">IDENTIFICACIÓN</th>
            <th class="text-center whitespace-no-wrap">ROL</th>
            ...
            <tr class="intro-x" key={user.id}>
                ...
                <td class="text-center">
                    <div class="flex justify-center items-center">
                        <a class="flex items-center mr-3" title="Editar usuario" href="{{route('edit-user',$user->id)}}">
