...
class StoreTypeVoucherPost extends FormRequest
{
    /**
    ...
    {
        return [
            'document'=>'unique:type_vouchers|required|regex:/^[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+$/u',
            'abbreviation'=>'unique:type_vouchers|required|regex:/^[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+$/u',
